    ...
    <div style={{ display: 'flex', minHeight: '100vh' }}>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  background: active ? 'rgba(232,168,56,0.2)' : 'transparent',
                  border: 'none',
                  borderLeft: active ? '3px solid #E8A838' : '3px solid transparent',
                  color: active ? '#E8A838' : 'rgba(255,255,255,0.7)',
                  fontSize: 13,
      ...
      <div style={{ marginLeft: 240, flex: 1, display: 'flex', flexDirection: 'column' }} className="main-content">
        ...
        <header style={{
          ...
          <button onClick={() => setSidebarOpen(true)} style={{ background: 'none', border: 'none', fontSize: 22, cursor: 'pointer' }}>
            ☰
          </button>
          <span style={{ fontWeight: 700, color: '#E8A838' }}>🍱 Kedai MangLeman</span>
        </header>

        <main style={{ flex: 1, padding: '1.5rem', maxWidth: 1200, width: '100%' }}>
          {children}
        </main>
      </div>
